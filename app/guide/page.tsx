...
export default function GuideIndexPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14">
      ...
      <p className="mt-3 max-w-xl text-[15px] leading-[1.7] text-ink-soft">
        6단계는 실제 연구가 흘러가는 순서와 같습니다. 먼저 무엇을 알아낼지
        정하고(주제 선정) 이미 나온 결과를 확인합니다(선행연구 조사). 그다음
        확인할 방법을 짜서(방법론 설계) 자료를 모으고(데이터 수집), 결과를
        글로 정리해(논문화) 다른 사람이 볼 수 있는 곳에 내놓습니다(저널
        투고). 전부 다 밟을 필요는 없습니다. 학교 수행평가라면 5단계에서
        끝내도 되고, 대회를 준비한다면 6단계까지 이어집니다.
      </p>
      <p className="mt-3 max-w-xl text-[15px] leading-[1.7] text-ink-soft">
