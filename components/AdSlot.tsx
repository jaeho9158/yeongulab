...
import { ADSENSE_CLIENT_ID, adSlotsEnabled } from "@/lib/site";

/**
 * Google AdSense 광고 슬롯.
 *
 * 로더 스크립트(adsbygoogle.js)는 `app/layout.tsx`에서 항상 싣는다(소유권
 * 확인용). 실제 광고 단위는 `NEXT_PUBLIC_ADSENSE_SLOTS=on`일 때만
 * 렌더링되고, 아니면 아무것도 그리지 않는다 — 승인 전 빈 점선 박스가
 * 본문에 노출되는 일을 막기 위해서다.
 *
