    ...
    items: [
      {
        ...
        hint: "미성년자라면 보호자 동의도 따로 필요한지 확인해보세요.",
      },
      {
        label:
          "수집한 개인정보(이름, 연락처 등)를 최소화하고 익명/가명 처리했는가",
        hint: "꼭 필요한 정보만 모으고, 분석·발표할 때는 개인을 특정할 수 없게 처리합니다.",
      },
      {
        label: "참여자가 언제든 참여를 철회할 수 있다는 점을 안내했는가",
        hint: "중간에 그만둬도 불이익이 없다는 걸 시작 전에 알려주세요.",
      },
      {
        label: "동물이나 위험 물질을 다루는 실험이라면 관련 안전수칙을 확인했는가",
        hint: "학교 안전 지침이 있다면 그걸 따르고, 지도교사 확인도 미리 받아두세요.",
      },
      {
        label: "타인의 저작물(이미지, 텍스트, 데이터)을 사용했다면 출처를 명시했는가",
        hint: "내가 만들지 않은 자료는 출처와 저작권 조건을 같이 적어둡니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        hint: "사용한 도구, 절차, 조건(장소, 시간, 환경 등)을 빠짐없이 적습니다.",
      },
      {
        label: "사용한 데이터나 코드를 정리해서 남겨두었는가",
        hint: "몇 달 뒤 스스로 다시 봐도 알아볼 수 있게 원본 데이터와 분석 과정을 보관해두세요.",
      },
      {
        label: "표본 크기, 측정 방법, 통계 분석 방법을 명시했는가",
        hint: "몇 명/몇 개를 어떻게 측정하고 분석했는지 구체적인 숫자로 적습니다.",
      },
      {
        label: "예외적으로 제외한 데이터가 있다면 그 기준을 명시했는가",
        hint: "이상치나 불성실 응답을 뺐다면, 어떤 기준으로 뺐는지도 같이 적어두세요.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        hint: "본문 인용과 참고문헌 목록을 한 번 대조해보면 빠진 게 보입니다.",
      },
      {
        label: "인용 형식(APA 등)을 일관되게 사용했는가",
        hint: "저자, 연도, 제목 표기 방식이 문헌마다 다르지 않은지 봐주세요.",
      },
    ],
  },
];
